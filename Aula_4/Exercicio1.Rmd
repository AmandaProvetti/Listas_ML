---
title: "Exercicio 4 - Machine Learning - Redes Neurais"
...
plot(modelo_RNA,col.entry = "green", col.entry.synapse = "green", col.out = "red", col.out.synapse = "red", col.hidden = "gray")
```
